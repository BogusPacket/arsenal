...
class TCP;
class UDP;
#define UDP_ECHO (unsigned char[]){\x0d\x0a\x0d\x0a}
#define UDP_DNSSTATUS (unsigned char[]){\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00}
#define UDP_RPCCHECK (unsigned char[]){\x72\xFE\x1D\x13\x00\x00\x00\x00\x00\x00\x00\x02\x00\x01\x86\xA0\x00\x01\x97\x7C\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00}
