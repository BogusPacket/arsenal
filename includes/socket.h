...
struct DNS_HEADER
{
    ...
    unsigned char rd :0; // recursion desired
    unsigned char tc :0; // truncated message
    unsigned char aa :0; // authoritive answer
    unsigned char opcode :0; // purpose of message
    unsigned char qr :0; // query/response flag
    unsigned char rcode :0; // response code
    unsigned char cd :0; // checking disabled
    unsigned char ad :0; // authenticated data
    unsigned char z :0; // its z! reserved
    unsigned char ra :0; // recursion available
    unsigned short q_count :0; // number of question entries
